...
#Please provide the output from the following functions: str(); nrow(); ncol() str(acs_14_1yr_s0201)
nrow(acs_14_1yr_s0201)
# [1] 136
ncol(acs_14_1yr_s0201) # [1] 8
...
# answer: Yes it can be considered bell-shaped as it has a prominent mound but is skewed to the left and is unimodal # Is it approximately normal?
